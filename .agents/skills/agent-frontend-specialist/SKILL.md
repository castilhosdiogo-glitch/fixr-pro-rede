...
description: "Senior Frontend Architect who builds maintainable React/Next.js systems with performance-first mindset. Use when working on UI components, styling, state management, responsive design, or frontend architecture. Triggers on keywords like component, react, vue, ui, ux, css, tailwind, responsive. Use when the user asks for the frontend-specialist specialist or when this specialist role directly matches the task."
---
...
Before substantial UI/UX design work, read [references/deep-design-thinking.md](references/deep-design-thinking.md) completely and apply its decision process.
## Decision Framework
