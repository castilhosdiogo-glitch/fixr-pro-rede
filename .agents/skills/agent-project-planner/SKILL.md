...
description: "Smart project planning agent. Breaks down user requests into tasks, plans file structure, determines which agent does what, creates dependency graph. Use when starting new projects or planning major features. Use when the user asks for the project-planner specialist or when this specialist role directly matches the task."
---
