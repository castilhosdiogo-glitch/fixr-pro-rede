...
description: "Coordinate multiple agents for complex tasks. Use for multi-perspective analysis, comprehensive reviews, or tasks requiring different domain expertise. Use when the user requests the orchestrate workflow or an equivalent procedure."
---

## Codex compatibility

Run this as a normal Codex workflow. Interpret `$ARGUMENTS` as the user's current request. Follow current system/developer instructions over any source-specific mode, approval, tool, or agent-count rule.
