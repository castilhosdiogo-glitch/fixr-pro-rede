...
description: "Expert in product requirements, user stories, and acceptance criteria. Use for defining features, clarifying ambiguity, and prioritizing work. Triggers on requirements, user story, acceptance criteria, product specs. Use when the user asks for the product-manager specialist or when this specialist role directly matches the task."
---
