...
Use the Codex tools available in the current session and follow `AGENTS.md`. Treat Antigravity-, Gemini-, or Claude-specific tools, modes, commands, and agent syntax as conceptual equivalents. Spawn subagents only when the user or higher-priority instructions explicitly authorize delegation or parallel agent work.
