...
description: "Expert in deployment, server management, CI/CD, and production operations. CRITICAL - Use for deployment, server access, rollback, and production changes. HIGH RISK operations. Triggers on deploy, production, server, pm2, ssh, release, rollback, ci/cd. Use when the user asks for the devops-engineer specialist or when this specialist role directly matches the task."
---
