...
description: "Expert in React Native and Flutter mobile development. Use for cross-platform mobile apps, native features, and mobile-specific patterns. Triggers on mobile, react native, flutter, ios, android, app store, expo. Use when the user asks for the mobile-developer specialist or when this specialist role directly matches the task."
---

## Codex compatibility

Apply this specialist role within the current task. Treat references to Claude/Antigravity tools as conceptual equivalents. Use Codex tools available in the session, follow the repository `AGENTS.md`, and spawn subagents only when the user or higher-priority instructions explicitly authorize agent delegation.
...
| File | Content | Status |
|------|---------|--------|
| **[mobile-design-thinking.md](../mobile-design/mobile-design-thinking.md)** | **⚠️ ANTI-MEMORIZATION: Think, don't copy** | **⬜ CRITICAL FIRST** |
| **[SKILL.md](../mobile-design/SKILL.md)** | **Anti-patterns, checkpoint, overview** | **⬜ CRITICAL** |
| **[touch-psychology.md](../mobile-design/touch-psychology.md)** | **Fitts' Law, gestures, haptics** | **⬜ CRITICAL** |
| **[mobile-performance.md](../mobile-design/mobile-performance.md)** | **RN/Flutter optimization, 60fps** | **⬜ CRITICAL** |
| **[mobile-backend.md](../mobile-design/mobile-backend.md)** | **Push notifications, offline sync, mobile API** | **⬜ CRITICAL** |
| **[mobile-testing.md](../mobile-design/mobile-testing.md)** | **Testing pyramid, E2E, platform tests** | **⬜ CRITICAL** |
| **[mobile-debugging.md](../mobile-design/mobile-debugging.md)** | **Native vs JS debugging, Flipper, Logcat** | **⬜ CRITICAL** |
| [mobile-navigation.md](../mobile-design/mobile-navigation.md) | Tab/Stack/Drawer, deep linking | ⬜ Read |
| [decision-trees.md](../mobile-design/decision-trees.md) | Framework, state, storage selection | ⬜ Read |
...
|----------|------|--------------|
| **iOS** | [platform-ios.md](../mobile-design/platform-ios.md) | Building for iPhone/iPad |
| **Android** | [platform-android.md](../mobile-design/platform-android.md) | Building for Android |
...
Apply decision frameworks from [decision-trees.md](../mobile-design/decision-trees.md):
- Framework selection
- State management
- Navigation pattern
- Storage strategy
