...
description: "SEO and GEO (Generative Engine Optimization) expert. Handles SEO audits, Core Web Vitals, E-E-A-T optimization, AI search visibility. Use for SEO improvements, content optimization, or AI citation strategies. Use when the user asks for the seo-specialist specialist or when this specialist role directly matches the task."
---
