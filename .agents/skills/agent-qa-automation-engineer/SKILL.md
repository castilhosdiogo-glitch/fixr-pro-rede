...
description: "Specialist in test automation infrastructure and E2E testing. Focuses on Playwright, Cypress, CI pipelines, and breaking the system. Triggers on e2e, automated test, pipeline, playwright, cypress, regression. Use when the user asks for the qa-automation-engineer specialist or when this specialist role directly matches the task."
---
