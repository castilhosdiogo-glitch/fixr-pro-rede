...
export const professionals: Professional[] = [
  ...
  },
  {
    ...
    verified: true,
    premium: false,
    description: "Encanador com experiência em instalações hidráulicas, desentupimentos e reparos. Atendo toda a zona sul do Rio.",
    experience: "15 anos",
    phone: "(21) 99999-0003",
    reviews: [
  ...
  },
  {
    ...
    verified: false,
    premium: false,
    description: "Chaveiro 24 horas. Abertura de portas, troca de segredo, cópias de chaves. Atendimento rápido em toda BH.",
    experience: "6 anos",
    phone: "(31) 99999-0005",
    reviews: [
